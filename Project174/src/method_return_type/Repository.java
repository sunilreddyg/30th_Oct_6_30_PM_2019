...
public class Repository 
{
	...
	/*
	 * Keyword:-->   [Method launch chrome,firefox,ie browsers]
	 * Author:-->
	 * Create Date:-->
	 * Reviewed By:-->
	 * LastUpdate date:-->
	 ...
	 */
	 ...
	 /*
		 ...
		 */	 
		 ...
		 /*
		 * KeywordName:--> Verify title presented
		 * Author:-->
		 * CreatedOn;-->
		 * ReviewedBy:-->
		 * Parameters used:--> Local
		...
		public boolean isTitle_Presented(String Exp_title)
		{
		 ...
		 /*
		 * KeywordName:--> Verify url presented
		 * Author:-->
		 * CreatedOn;-->
		 * ReviewedBy:-->
		 * Parameters used:--> Local
		 ...
		 * LastUpdationDate:-->
		 */	 
	 	public boolean isInput_presented_At_Editbox(WebElement Element,String input)
	 	{
	 		try {
	 			boolean flag=wait.until(ExpectedConditions.textToBePresentInElementValue(Element, input));
	 			return flag;
			} catch (Exception e) {
				return false;
			}
